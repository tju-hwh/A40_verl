...
OWNER_GPU_MEM_UTIL="${OWNER_GPU_MEM_UTIL:-0.26}"
CONSUMER_GPU_MEM_UTIL="${CONSUMER_GPU_MEM_UTIL:-0.26}"
OWNER_MAX_NUM_SEQS="${OWNER_MAX_NUM_SEQS:-1024}"
CONSUMER_MAX_NUM_SEQS="${CONSUMER_MAX_NUM_SEQS:-1024}"
