...
project_name='GRPO'
exp_name='GRPO-Qwen3-0.6b-deepmath-rollout-only'
...
HOP_DECODE_CUTOVERS=${HOP_DECODE_CUTOVERS:-"[2048]"}
HOP_MAX_RESPONSE_LENGTH=${HOP_MAX_RESPONSE_LENGTH:-3072}
HOP_REQUEST_TIMEOUT_S=${HOP_REQUEST_TIMEOUT_S:-600.0}
HOP_CONNECT_TIMEOUT_S=${HOP_CONNECT_TIMEOUT_S:-60.0}
HOP_HTTP_MAX_CONNECTIONS=${HOP_HTTP_MAX_CONNECTIONS:-1024}
...
HOP_SEND_PUBLISH_TOKEN_STRIDE=${HOP_SEND_PUBLISH_TOKEN_STRIDE:-3072}
...
HOP_OWNER_GPU_MEM_UTIL=${HOP_OWNER_GPU_MEM_UTIL:-0.16}
HOP_CONSUMER_GPU_MEM_UTIL=${HOP_CONSUMER_GPU_MEM_UTIL:-0.16}
HOP_OWNER_MAX_NUM_SEQS=${HOP_OWNER_MAX_NUM_SEQS:-512}
HOP_CONSUMER_MAX_NUM_SEQS=${HOP_CONSUMER_MAX_NUM_SEQS:-512}
...
HOP_MPS_ACTIVE_THREAD_PERCENTAGES=${HOP_MPS_ACTIVE_THREAD_PERCENTAGES:-"[100,30]"}

TRAINING_ENABLE_CUDA_MPS=${TRAINING_ENABLE_CUDA_MPS:-true}
ACTOR_MPS_ACTIVE_THREAD_PERCENTAGE=${ACTOR_MPS_ACTIVE_THREAD_PERCENTAGE:-90}
REF_MPS_ACTIVE_THREAD_PERCENTAGE=${REF_MPS_ACTIVE_THREAD_PERCENTAGE:-90}
CRITIC_MPS_ACTIVE_THREAD_PERCENTAGE=${CRITIC_MPS_ACTIVE_THREAD_PERCENTAGE:-90}
...
OWNER_COMPILATION_CONFIG=${OWNER_COMPILATION_CONFIG:-'{level:3,use_inductor:true,use_cudagraph:true,cudagraph_capture_sizes:[1,2,4,8,16,24,32,40,48,56,64,72,80,88,96,104,112,120,128,136,144,152,160,168,176,184,192,200,208,216,224,232,240,248,256,272,288,304,320,336,352,368,384,400,416,432,448,464,480,496,512]}'}
SERVER2_COMPILATION_CONFIG=${SERVER2_COMPILATION_CONFIG:-'{level:3,use_inductor:true,use_cudagraph:true,cudagraph_capture_sizes:[1,2,4,8,16,24,32,40,48,56,64,72]}'}
...
python3 -m recipe.one_step_off_policy.main_ppo \
    ...
    "+trainer.stream_train_pipe=True" \
