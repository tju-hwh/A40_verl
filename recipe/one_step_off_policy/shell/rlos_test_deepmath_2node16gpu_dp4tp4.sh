...
# export TRAIN_GROUP_PLAN="${TRAIN_GROUP_PLAN:-[32,32,32,32,32,32,32,32,32,32,32,32,32,16,16,16,16,16,16]}"
# export TRAIN_GROUP_PLAN="${TRAIN_GROUP_PLAN:-[48, 48, 48, 48, 48, 48, 48, 48, 48, 32, 32, 16]}"
# export TRAIN_GROUP_PLAN="${TRAIN_GROUP_PLAN:-[48, 48, 48, 48, 48, 48, 48, 48, 48, 32, 32, 16]}"
export TRAIN_GROUP_PLAN="${TRAIN_GROUP_PLAN:-[64,64,64,64,64,64,64,32,32]}"
...
export HOP_DECODE_CUTOVERS="${HOP_DECODE_CUTOVERS:-[1526]}"
...
HOP_OWNER_GPU_MEM_UTIL="${HOP_OWNER_GPU_MEM_UTIL:-0.26}"
HOP_CONSUMER_GPU_MEM_UTIL="${HOP_CONSUMER_GPU_MEM_UTIL:-0.26}"
...
HOP_HTTP_MAX_KEEPALIVE_CONNECTIONS="${HOP_HTTP_MAX_KEEPALIVE_CONNECTIONS:-1024}"
