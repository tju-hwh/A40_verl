...
HOP_STARTUP_TIMEOUT_S=${HOP_STARTUP_TIMEOUT_S:-300.0}
...
KV_HANDOFF_GLOBAL_PHASE_BARRIER=${KV_HANDOFF_GLOBAL_PHASE_BARRIER:-true}

HOP_OWNER_GPU_MEM_UTIL=${HOP_OWNER_GPU_MEM_UTIL:-0.3}
HOP_CONSUMER_GPU_MEM_UTIL=${HOP_CONSUMER_GPU_MEM_UTIL:-0.3}
...
SERVER2_COMPILATION_CONFIG=${SERVER2_COMPILATION_CONFIG:-'{level:3,use_inductor:true,use_cudagraph:true,cudagraph_capture_sizes:[1,2,4,8,16,24,32,40,48,56,64,72,80,88,96,104,112,120,128,136,144,152,160,168,176,184,192,200,208,216,224,232,240,248,256,272,288,304,320,336,352,368,384,400,416,432,448,464,480,496,512]}'}
...
KV_HANDOFF_GLOBAL_PHASE_BARRIER="${KV_HANDOFF_GLOBAL_PHASE_BARRIER}" \
"${PYTHON_BIN}" -m recipe.one_step_off_policy.main_rollout_only \
    ...
    actor_rollout_ref.rollout.tensor_model_parallel_size=${HOP_OWNER_TP_SIZE} \
