...
HOP_DECODE_CUTOVERS=${HOP_DECODE_CUTOVERS:-"[3000]"}
...
HOP_SEND_PUBLISH_TOKEN_STRIDE=${HOP_SEND_PUBLISH_TOKEN_STRIDE:-3000}
...
HOP_MPS_ACTIVE_THREAD_PERCENTAGES=${HOP_MPS_ACTIVE_THREAD_PERCENTAGES:-"[100,80]"}
...
OWNER_COMPILATION_CONFIG=${OWNER_COMPILATION_CONFIG:-'{level:3,use_inductor:true,use_cudagraph:true,cudagraph_capture_sizes:[16,24,32,40,48,56,64,72,64,72,80,88,96,104,112,120,128]}'}
SERVER2_COMPILATION_CONFIG=${SERVER2_COMPILATION_CONFIG:-'{level:3,use_inductor:true,use_cudagraph:true,cudagraph_capture_sizes:[1,2,4,8,16]}'}
