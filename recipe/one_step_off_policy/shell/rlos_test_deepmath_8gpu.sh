...
HOP_DECODE_CUTOVERS=${HOP_DECODE_CUTOVERS:-"[6144]"}
HOP_MAX_RESPONSE_LENGTH=${HOP_MAX_RESPONSE_LENGTH:-8192}
...
HOP_SEND_PUBLISH_TOKEN_STRIDE=${HOP_SEND_PUBLISH_TOKEN_STRIDE:-6144}
...
HOP_OWNER_GPU_MEM_UTIL=${HOP_OWNER_GPU_MEM_UTIL:-0.32}
HOP_CONSUMER_GPU_MEM_UTIL=${HOP_CONSUMER_GPU_MEM_UTIL:-0.32}
HOP_OWNER_MAX_NUM_SEQS=${HOP_OWNER_MAX_NUM_SEQS:-128}
HOP_CONSUMER_MAX_NUM_SEQS=${HOP_CONSUMER_MAX_NUM_SEQS:-128}
HOP_OWNER_TP_SIZE=${HOP_OWNER_TP_SIZE:-8}
HOP_CONSUMER_TP_SIZE=${HOP_CONSUMER_TP_SIZE:-8}
HOP_OWNER_CUDA_VISIBLE_DEVICES=${HOP_OWNER_CUDA_VISIBLE_DEVICES:-"0,1,2,3,4,5,6,7"}
HOP_CONSUMER_CUDA_VISIBLE_DEVICES_ALL=${HOP_CONSUMER_CUDA_VISIBLE_DEVICES_ALL:-"0,1,2,3,4,5,6,7"}
...
HOP_MPS_ACTIVE_THREAD_PERCENTAGES=${HOP_MPS_ACTIVE_THREAD_PERCENTAGES:-"[100,65]"}
...
OWNER_COMPILATION_CONFIG=${OWNER_COMPILATION_CONFIG:-'{level:3,use_inductor:true,use_cudagraph:true,cudagraph_capture_sizes:[88,96,104,112,120,128]}'}
SERVER2_COMPILATION_CONFIG=${SERVER2_COMPILATION_CONFIG:-'{level:3,use_inductor:true,use_cudagraph:true,cudagraph_capture_sizes:[1,2,4,8,16,24,32,40,48,56,64,72,64,72,80,88,96]}'}
